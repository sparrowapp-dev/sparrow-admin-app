...
<div class="custom-toast-container">
  <ToastContainer width={'fit-content'} let:data>
    <div
      class="custom-toast relative flex rounded-md custom-toast-{data.type} toast"
      style="height: {data.title === undefined ? '68px' : '84px'};"
    >
      <div class="content-wrapper flex w-full gap-1">
        <div class="flex">
          <span class="icon relative">
            <span class="icon-backdrop icon-backdrop-{data.type}" />
            <div class="bg-circle flex items-center justify-center">
              <div class="bg-circle-{data.type} flex items-center justify-center">
      ...
      <div class="close-icon-large flex items-center justify-center">
        <button
          on:click={() => {
