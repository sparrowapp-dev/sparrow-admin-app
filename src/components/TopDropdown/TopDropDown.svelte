  ...
  <div class="relative">
    ...
    {#if isOpen}
      <div
        ...
        class={`bg-surface-600 absolute right-0 z-50 w-40 rounded-sm shadow-lg ${openUp ? 'bottom-full mb-2' : 'mt-2'} text-fs-ds-12 font-regular leading-lh-ds-130  text-neutral-50`}
      >
        <div class="bg-surface-600 flex flex-col gap-1 rounded-sm py-1">
          <button
            class="hover:bg-surface-300 flex w-full cursor-pointer items-center gap-2 px-2 py-1 text-neutral-50"
